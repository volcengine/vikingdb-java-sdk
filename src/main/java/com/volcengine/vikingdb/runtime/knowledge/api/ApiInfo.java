...
public class ApiInfo {
    ...
    public static final ApiInfo CHAT_COMPLETIONS = new ApiInfo("ChatCompletions", Method.POST,
    ...
    public static final ApiInfo LIST_DOCS_V2 = new ApiInfo("ListDocsV2", Method.POST, "/api/knowledge/doc/v2/list");
    public static final ApiInfo SEARCH_DOCS_BY_FILTER = new ApiInfo("SearchDocsByFilter", Method.POST,
            "/api/knowledge/doc/v2/search_by_filter");
    public static final ApiInfo UPDATE_DOC_META = new ApiInfo("UpdateDocMeta", Method.POST,
    ...
    public static final ApiInfo SEARCH_COLLECTION = new ApiInfo("SearchCollection", Method.POST,
            "/api/knowledge/collection/search");
    public static final ApiInfo SEARCH_KNOWLEDGE = new ApiInfo("SearchKnowledge", Method.POST,
