...
public class UpdateDataTest {
    ...
    @Test
    public void testUpdateDataV1() throws Exception {
        UpdateDataRequest request = UpdateDataRequest
                .builder()
                .collectionName(TestVar.COLLECTION_NAME)
                .data(Arrays.asList(
                        new HashMap<String,Object>(){{put("f_int64", 1);put("f_vector", Util.generateRandomVector(4));}},
                        new HashMap<String,Object>(){{put("f_int64", 2);put("f_vector", Util.generateRandomVector(4));}},
                        new HashMap<String,Object>(){{put("f_int64", 3);put("f_vector", Util.generateRandomVector(4));}}
                ))
                .build();
        DataApiResponse<UpdateDataResult> response = service.updateData(request);
