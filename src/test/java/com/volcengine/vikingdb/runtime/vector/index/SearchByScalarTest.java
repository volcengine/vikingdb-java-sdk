...
import com.volcengine.vikingdb.runtime.vector.model.request.Order;
...
public class SearchByScalarTest {
    ...
    public void testSearchByScalarV1() throws Exception {
        SearchByScalarRequest request = SearchByScalarRequest.builder()
                ...
                .build();
        DataApiResponse<SearchResult> response = service.searchByScalar(request);
